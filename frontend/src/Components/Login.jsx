...
function Login({ setLandingPage, setToken }) {
  ...
  return (
    <div className=" relative w-full h-screen bg-gradient-to-r from-[#0083b05d] to-[#db009e53] flex items-center justify-center">
      <div className=" relative w-[75%] h-[80%]  bg-white rounded-3xl flex ">
        ...
        <div className="w-[100%] sm:w-[68%] h-full rounded-3xl pt-10  pb-5 px-5 sm:px-10 flex flex-col gap-5">
          <p className="text-[#D885A3] text-4xl font-bold px-2">Let's Chat</p>
          <div className="signupcontainer w-[100%] sm:w-[90%] md:w-[60%] xl:w-[55%] flex flex-col gap-5 px-2 overflow-y-scroll">
            <p className="font-bold text-xl mt-3">Log In</p>
            <form
              onSubmit={(e) => {
                handleSubmit(e);
              }}
